...
import SelectSpellSourceInput, {
  mapDataToSource,
  mapSourceToData,
} from './select-source-input';
...
const SourceField = formField(SelectSpellSourceInput, 'source', {
  mapDataToValue: mapDataToSource,
  mapValueToData: mapSourceToData,
});
