  ...
  describe('with default options', () => {
    ...
    describe('middleware', () => {
      ...
      describe('reloadData', () => {
        ...
        it('should have type resource/store/middleware/reloadData', () => {
          expect(reloadData.type).toEqual('resource/store/middleware/reloadData');
        });

        it('should be configured with options', () => {
          const { options } = reloadData;
          const expected = { performRequest: findRequest };
    ...
    describe('type', () => {
      it('should be resource/index-page/destroy', () => {
        expect(client.type).toEqual('resource/index-page/destroy');
      });
    });
