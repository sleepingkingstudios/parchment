import DeleteOneEndpoint from './index';
...
describe('DeleteOneEndpoint', () => {
  ...
  describe('with default options', () => {
    ...
    const endpoint = new DeleteOneEndpoint(options);
    const {
      actions,
      hooks,
      namespace,
    ...
    describe('request', () => {
      it('should instantiate the request', () => {
        expect(request).toBeInstanceOf(DeleteOneRequest);
      });
