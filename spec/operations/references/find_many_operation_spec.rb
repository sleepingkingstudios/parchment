...
RSpec.describe Operations::References::FindManyOperation do
  ...
  describe '#call' do
    ...
    context 'when there are many records' do
      ...
      describe 'with a valid primary key' do
        ...
        # rubocop:disable RSpec/NestedGroups
        context 'when the record has a source' do
          let(:source) do
          ...
          it 'should assign the source' do
            expect(call_operation.value.first.source).to be == source
          end

          it 'should warm the association cache' do
            expect(call_operation.value.first.association_cached?(:source))
              .to be true
          end
        end
        # rubocop:enable RSpec/NestedGroups
